...
/* harmony import */ var _layout_job_categories_job_categories_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./layout/job-categories/job-categories.component */ "./src/app/layout/job-categories/job-categories.component.ts");
/* harmony import */ var _shared_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./shared/services/auth.guard.service */ "./src/app/shared/services/auth.guard.service.ts");
...
var routes = [
    ...
    { path: 'dashboard', component: _layout_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_6__["DashboardComponent"], canActivate: [_shared_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
    { path: 'reports', component: _layout_reports_reports_component__WEBPACK_IMPORTED_MODULE_7__["ReportsComponent"], canActivate: [_shared_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
    { path: 'profile', component: _layout_profile_profile_component__WEBPACK_IMPORTED_MODULE_8__["ProfileComponent"], canActivate: [_shared_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
    { path: 'edit-profile', component: _layout_edit_profile_edit_profile_component__WEBPACK_IMPORTED_MODULE_9__["EditProfileComponent"], canActivate: [_shared_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
    { path: 'change-password', component: _layout_chang_password_chang_password_component__WEBPACK_IMPORTED_MODULE_10__["ChangPasswordComponent"], canActivate: [_shared_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
    { path: 'setting', component: _layout_settings_settings_component__WEBPACK_IMPORTED_MODULE_12__["SettingsComponent"], canActivate: [_shared_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
    { path: 'user-management', component: _layout_user_management_user_management_component__WEBPACK_IMPORTED_MODULE_11__["UserManagementComponent"], canActivate: [_shared_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
    { path: 'professional-management', component: _layout_professional_management_professional_management_component__WEBPACK_IMPORTED_MODULE_15__["ProfessionalManagementComponent"], canActivate: [_shared_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
    { path: 'job-categorie', component: _layout_job_categories_job_categories_component__WEBPACK_IMPORTED_MODULE_16__["JobCategoriesComponent"], canActivate: [_shared_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]] },
];
...
/* harmony import */ var _layout_job_categories_job_categories_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./layout/job-categories/job-categories.component */ "./src/app/layout/job-categories/job-categories.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _layout_job_categories_job_categories_component__WEBPACK_IMPORTED_MODULE_29__["JobCategoriesComponent"],
            ],
            imports: [
...
/***/ "./src/app/layout/job-categories/job-categories.component.css":
/*!********************************************************************!*\
  !*** ./src/app/layout/job-categories/job-categories.component.css ***!
  \********************************************************************/
/*! no static exports found */
...
module.exports = "table {\n    width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/layout/job-categories/job-categories.component.html":
/*!*********************************************************************!*\
  !*** ./src/app/layout/job-categories/job-categories.component.html ***!
  \*********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/layout/job-categories/job-categories.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/layout/job-categories/job-categories.component.ts ***!
  \*******************************************************************/
/*! exports provided: JobCategoriesComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobCategoriesComponent", function() { return JobCategoriesComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_services_http_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/services/http.service */ "./src/app/shared/services/http.service.ts");
...
var JobCategoriesComponent = /** @class */ (function () {
    function JobCategoriesComponent(api, fb, utils, router, excelService) {
        this.api = api;
        this.fb = fb;
        this.utils = utils;
        this.router = router;
        this.excelService = excelService;
        this.displayedColumns = ['position', 'Name_English', 'Name_portugues', 'action'];
        this.Userlist = [];
        ...
        this.newJob = this.fb.group({
            cat_name: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required],
            cat_name_portugues: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required],
        });
    }
    JobCategoriesComponent.prototype.ngOnInit = function () {
    ...
    JobCategoriesComponent.prototype.getEmployeeList = function () {
        var _this = this;
        this.api.getCategorieList().subscribe(function (data) {
    ...
    Object.defineProperty(JobCategoriesComponent.prototype, "f", {
        get: function () { return this.newJob.controls; },
        enumerable: true,
        configurable: true
    });
    JobCategoriesComponent.prototype.createUser = function () {
        var _this = this;
        this.submitted = true;
        ...
        this.api.create_cat(dataToSend).subscribe(function (data) {
            _this.utils.alert('success', data['message']);
            $('#addUser').modal('hide');
    ...
    JobCategoriesComponent.prototype.create_cat = function () {
        this.updateUser = false;
        this.newJob = this.fb.group({
            cat_name: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required],
            cat_name_portugues: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required],
    ...
    JobCategoriesComponent.prototype.selectEditUser = function (a) {
        this.updateUser = true;
        this.value_to_show = a;
        this.newJob = this.fb.group({
            cat_name: [this.value_to_show.cat_name, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required],
            cat_name_portugues: [this.value_to_show.cat_name_portugues, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required],
        });
    };
    JobCategoriesComponent.prototype.selectDeleteUser = function (user) {
        this.selectedDeleteUser = user;
    };
    JobCategoriesComponent.prototype.deleteUser = function () {
        var _this = this;
        debugger;
        var dataToSend = {
            _id: this.selectedDeleteUser._id
        };
        this.api.delete_create_cat(dataToSend).subscribe(function (data) {
            _this.utils.alert('success', data['message']);
            _this.getEmployeeList();
        }, function (error) {
            _this.utils.alert(error, error.error.message);
    ...
    JobCategoriesComponent.prototype.updateSelectedUser = function () {
        var _this = this;
        this.submitted = true;
        if (this.newJob.invalid) {
            return;
        ...
        this.api.edit_create_cat(dataToSend).subscribe(function (data) {
            _this.utils.alert('success', data['message']);
            $('#addUser').modal('hide');
            _this.getEmployeeList();
        }, function (error) {
    ...
    JobCategoriesComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
    };
    JobCategoriesComponent.prototype.exportAsXLSX = function () {
    ...
    ], JobCategoriesComponent.prototype, "paginator", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    ], JobCategoriesComponent.prototype, "sort", void 0);
    JobCategoriesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-job-categories',
            template: __webpack_require__(/*! ./job-categories.component.html */ "./src/app/layout/job-categories/job-categories.component.html"),
            styles: [__webpack_require__(/*! ./job-categories.component.css */ "./src/app/layout/job-categories/job-categories.component.css")]
        }),
...
var ProfessionalManagementComponent = /** @class */ (function () {
    ...
    ProfessionalManagementComponent.prototype.selectviewdata = function (element) {
        this.datatoshow = element;
        if (element.profile_image != "N/A") {
            this.imagetoshow = element.profile_image ? src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].imageUrl + element.profile_image : 'assets/img/3002121059.jpg';
        }
        else {
...
var UserManagementComponent = /** @class */ (function () {
    ...
    UserManagementComponent.prototype.selectviewdata = function (element) {
        this.datatoshow = element;
        if (element.profile_image != "N/A") {
            this.imagetoshow = element.profile_image ? src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].imageUrl + element.profile_image : 'assets/img/3002121059.jpg';
        }
...
var HttpService = /** @class */ (function () {
    ...
    //get categories
    HttpService.prototype.getCategorieList = function () {
        return this.http.get('admin/get_create_cat');
    };
    HttpService.prototype.create_cat = function (data) {
        return this.http.post('admin/create_cat', data);
    };
    HttpService.prototype.delete_create_cat = function (data) {
        return this.http.post('admin/delete_create_cat', data);
    };
    HttpService.prototype.edit_create_cat = function (data) {
...
var environment = {
    ...
    imageUrl: 'http://3.14.143.205:3000'
};
